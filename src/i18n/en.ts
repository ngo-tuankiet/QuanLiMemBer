...
export const en: Dict = {
  ...
  kpi: {
    ...
    hintCash:
      'Cash actually left in the broker accounts — reconcilable against the broker statement. ' +
      'The reserve is NOT deducted here; the deployable figure is on the line below.',
    hintCashNotFiltered:
