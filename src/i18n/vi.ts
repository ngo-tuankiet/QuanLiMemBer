...
export const vi = {
  ...
  kpi: {
     ...
     *
     * Số dư ít hơn mức dự phòng đã cấu hình thì không còn đồng nào để đặt lệnh —
     * và người đọc chỉ thấy "₫0" sẽ kết luận con số bị lỗi. Nói ra khoản còn thiếu
     * là nói ra CHÍNH LÝ DO của số 0 đó.
     */
    reserveShortfall: (tien: string) => `thiếu ${tien} so với mức dự phòng`,
    /** Phần được phép giải ngân sau khi giữ lại quỹ dự phòng. */
    deployable: (tien: string) => `còn ${tien} được giải ngân`,
    ...
    hintCash:
      'Tiền mặt còn trong các tài khoản chứng khoán — đối chiếu được với sao kê của sàn. ' +
      'Quỹ dự phòng KHÔNG bị trừ khỏi con số này; phần được phép giải ngân hiện ở dòng dưới.',
    hintCashNotFiltered:
