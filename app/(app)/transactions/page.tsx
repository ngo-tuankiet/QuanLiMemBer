                  ...
                  return (
                    ...
                    >
                      <td className="px-4 py-2.5">
                        {/*
                          MÃ LỆNH LÀ ĐƯỜNG DUY NHẤT VÀO TRANG CHI TIẾT, mà trang đó mới là
                          nơi sửa / huỷ / xoá. Một liên kết trông giống mã số thì không ai
                          đoán được nó mở ra cái gì — `title` nói thẳng ra.
                        */}
                        <Link
