  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        />
        {/*
          Tỷ trọng tính từ tiền KHẢ DỤNG — cùng con số mà thẻ đang hiện.
          `allocation.cashBps` là tỷ trọng toàn bộ số dư, dành cho biểu đồ phân bổ.
          Xem chú thích dài hơn ở thẻ tương ứng trên Dashboard.
        */}
        <StatCard
          ...
          hint={
            <Weight
              bps={ratioToBps(summary.cash.availableCash, summary.portfolioValue)}
              className="text-xs"
            />
          }
        />
        ...
        <div className="space-y-4">
          <Card className="p-5">
            ...
            <ul className="space-y-3">
              ...
              />
              {/* Tiền là MỘT phần — xem chú thích ở trang Phân bổ. */}
              <AllocRow
                label="Tiền mặt"
            ...
            {/*
              PHẦN BỊ GIỮ LẠI NÓI RA BẰNG CHỮ, chỉ khi có.

              Quỹ dự phòng không còn là một thanh riêng, nhưng nó vẫn trừ vào ô KPI
              "Tiền khả dụng" ngay phía trên. Không nói ra thì hai con số tiền trên
              cùng một trang lệch nhau mà không có gì giải thích.
            */}
            {summary.cash.reserveAmount > 0n ? (
              <p className="mt-3 border-t border-ink-800 pt-3 text-xs text-slate-muted">
                Trong đó{' '}
                <Money value={summary.cash.reserveAmount} className="text-warn-500" /> là quỹ
                dự phòng — đã trừ khỏi ô “{t.kpi.availableCash}”, không đặt lệnh được.
              </p>
            ) : null}
          </Card>
